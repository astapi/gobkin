...
export const SPELL_DEFS: Record<string, SpellDef> = {
  ...
  cure: {
    id: 'cure',
    name: getSpellLabel({ id: 'cure', name: 'キュア' }),
    power: 0,
    targeting: { type: 'all_allies' },
    defaultCharges: 1,
    effect: 'cure',
  ...
  heal_plus: {
    id: 'heal_plus',
    name: getSpellLabel({ id: 'heal_plus', name: 'ヒールプラス' }),
    power: 0,
    targeting: { type: 'single_ally_lowest_hp' },
    defaultCharges: 1,
    effect: 'heal',
  ...
  magic_barrier: {
    id: 'magic_barrier',
    name: getSpellLabel({ id: 'magic_barrier', name: 'マジックバリア' }),
    power: 0,
    targeting: { type: 'all_allies' },
    defaultCharges: 1,
    effect: 'barrier',
    magicDamageReductionPercent: 50,
  },
  full_heal: {
    id: 'full_heal',
    name: getSpellLabel({ id: 'full_heal', name: 'フルヒール' }),
    power: 0,
    targeting: { type: 'single_ally_below_half_hp' },
    defaultCharges: 1,
    effect: 'heal',
    fullHeal: true,
  },
